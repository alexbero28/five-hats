...
console.log(`\n  6. ${B('node sessions.mjs')} — the same before/after for HOW you work, counted from the`);
console.log('     sessions you already had. If you have your own CLAUDE.md, this is what tells you');
console.log('     when to load the standing rules into it — until then they sit beside it, unloaded.');
